export default function BorderedContentCard() {
    return (
        <a href="#" className="group relative block h-64 sm:h-80 lg:h-96">
            ...
            <div
                className="relative flex h-full transform items-end border-2 border-white bg-black transition-transform group-hover:-translate-x-2 group-hover:-translate-y-2"
            >
                <div
